...
public class AddDrivers extends JFrame implements ActionListener{
    ...
    JComboBox typecombo, availablecombo, gendercombo , cleancombo;
    ...
    AddDrivers() {
        ...
        lblroomno.setBounds(60,70,210,20);
        add(lblroomno);
        
        tfname = new JTextField();
        tfname.setBounds(200,70,150,25);
        add(tfname);
       ...
       tfage = new JTextField();
        tfage.setBounds(200,110,150,25);
        add(tfage);
